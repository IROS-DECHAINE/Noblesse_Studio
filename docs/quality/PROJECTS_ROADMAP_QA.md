...
La console du navigateur ne contient aucune erreur. Le premier test live a toutefois invalidé la stratégie V1 : un clic PrimeBot a ouvert le Project Browser sur Prime Industry avec le port global 8002. La V2 prépare désormais le projet et le port dans les préférences UEFN avant lancement, garde une sauvegarde SHA-256, sérialise les clics et conserve les arguments en renfort. Les contrats automatiques passent; le nouveau test live reste explicitement requis après redémarrage de l’application. Voir [la décision du lanceur](../DECISION_PROJECT_LAUNCHER_2026-08-21.md).
